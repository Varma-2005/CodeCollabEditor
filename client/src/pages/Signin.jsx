...
import { LogIn, Mail, Lock, Eye, EyeOff, Loader2, Code2, Zap } from 'lucide-react';
      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 border-4 border-gray-100">
          ...
          >
            ...
            <p className="text-gray-600 text-center mb-6 sm:mb-8 text-sm sm:text-base">Let's code together! 💻</p>
          </motion.div>
          ...
          >
            ...
            <Link to="/signup" className="text-pink-500 hover:text-pink-600 font-bold transition-colors">
              Sign Up
            </Link>
          </motion.p>
        </div>
